...
{
    [TestFixture]
    public class SqlSugarScopeDbContextTests
    {
        [SetUp]
        public void Setup()
        {
        ...
        {
            var obj = InitObject();
            var db = new TestDBScopeContext("test_sqlserver");
        ...
        {
            var obj = InitObject();
            var db = new TestDBScopeContext("test_mysql");
        ...
        {
            var obj = InitObject();
            var db = new TestDBScopeContext("test_sqlserver", "test_mysql");
            {
